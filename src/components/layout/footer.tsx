...
export function Footer() {
  ...
  const businessEmail = settings?.businessEmail ?? null;
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="font-heading text-brand-olive text-lg font-bold">
              {storeName}
            </h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              {siteConfig.navigation.footer.shop.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Join our family for exclusive deals and nursery tips.
            </p>
            <NewsletterForm />
          </div>
        </div>
